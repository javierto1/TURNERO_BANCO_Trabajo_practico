...
?>	
		...
		<div class="container" align="center">
					<div id="div1" class="divs">
						<h2 align="center"><b>Caja:</b> 3 </h2>
						<input name="button" type=image onclick="abrir()" class="img-circle img-responsive img-center" src="images/cajas/right_arrow-256.png"  value="1" id="3"></input>
					...
					<div class="divs1" style= "display:none; height:300px; width;300px" id="div3" class="divs" align="center">
						<input name="hola" type=image class="img-circle img-responsive img-center" src="images/cajas/close.png"  onclick="cerrar()" value="1" id="3"></input>
